...
static unsigned int sqlctx = 297355;
...
{12,4130,1,0,0,
5,0,0,0,0,0,27,29,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,37,0,4,38,0,0,2,0,0,1,0,2,3,0,0,2,9,0,0,
59,0,0,3,0,0,29,52,0,0,0,0,0,1,0,
};
...
int test_id[2];
/* varchar test_a[2][10]; */ 
struct { unsigned short len; unsigned char arr[10]; } test_a[2];
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select id ,a into :b0,:b1  from test ";
