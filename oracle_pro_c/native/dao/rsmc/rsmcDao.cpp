...
static unsigned int sqlctx = 326780;
...
{12,4130,1,0,0,
5,0,0,1,69,0,4,62,0,0,3,1,0,1,0,2,68,0,0,2,9,0,0,1,68,0,0,
32,0,0,2,38,0,3,85,0,0,3,3,0,1,0,1,68,0,0,1,9,0,0,1,68,0,0,
59,0,0,3,62,0,5,93,0,0,3,3,0,1,0,1,9,0,0,1,68,0,0,1,68,0,0,
86,0,0,4,36,0,2,101,0,0,1,1,0,1,0,1,68,0,0,
105,0,0,5,38,0,3,132,0,0,3,3,0,1,0,1,68,0,0,1,9,0,0,1,68,0,0,
132,0,0,6,62,0,5,147,0,0,3,3,0,1,0,1,9,0,0,1,68,0,0,1,68,0,0,
159,0,0,7,36,0,2,159,0,0,1,1,0,1,0,1,68,0,0,
};
...

{
    ...
    sqlstm.stmt = "select rsmc_type ,rsmc_name into :b0,:b1  from rsmc where\
 rsmc_id=:b2";
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into rsmc  values (:b0,:b1,:b2)";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update rsmc  set rsmc_name=:b0,rsmc_type=:b1 where rsmc_i\
d=:b2";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from rsmc  where rsmc_id=:b0";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into rsmc  values (:b1,:b2,:b3)";
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update rsmc  set rsmc_name=:b1,rsmc_type=:b2 where rsmc_i\
d=:b3";
    sqlstm.iters = (unsigned int  )loop;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from rsmc  where rsmc_id=:b1";
    sqlstm.iters = (unsigned int  )loop;
