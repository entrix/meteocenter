...
static unsigned int sqlctx = 21555836;
...
{12,4130,1,0,0,
5,0,0,1,147,0,4,77,0,0,7,1,0,1,0,2,68,0,0,2,9,0,0,2,68,0,0,2,4,0,0,2,4,0,0,2,4,
0,0,1,68,0,0,
48,0,0,2,60,0,3,117,0,0,7,7,0,1,0,1,68,0,0,1,68,0,0,1,9,0,0,1,68,0,0,1,4,0,0,1,
4,0,0,1,4,0,0,
91,0,0,3,136,0,5,126,0,0,7,7,0,1,0,1,68,0,0,1,9,0,0,1,68,0,0,1,4,0,0,1,4,0,0,1,
4,0,0,1,68,0,0,
134,0,0,4,48,0,2,141,0,0,1,1,0,1,0,1,68,0,0,
153,0,0,5,60,0,3,176,0,0,7,7,0,1,0,1,68,0,0,1,68,0,0,1,9,0,0,1,68,0,0,1,4,0,0,
1,4,0,0,1,4,0,0,
196,0,0,6,136,0,5,191,0,0,7,7,0,1,0,1,68,0,0,1,9,0,0,1,68,0,0,1,4,0,0,1,4,0,0,
1,4,0,0,1,68,0,0,
239,0,0,7,48,0,2,208,0,0,1,1,0,1,0,1,68,0,0,
};
...

{
    ...
    sqlstm.stmt = "select point_id ,datetime ,prediction ,height ,thickness \
,vertical_wind_shear into :b0,:b1,:b2,:b3,:b4,:b5  from tropopause where tropo\
pause_id=:b6";
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into tropopause  values (:b0,:b1,:b2,:b3,:b4,:b5,:\
b6)";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update tropopause  set point_id=:b0,datetime=:b1,predicti\
on=:b2,height=:b3,thickness=:b4,vertical_wind_shear=:b5 where tropopause_id=:b\
6";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from tropopause  where tropopause_id=:b0";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into tropopause  values (:b1,:b2,:b3,:b4,:b5,:b6,:\
b7)";
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update tropopause  set point_id=:b1,datetime=:b2,predicti\
on=:b3,height=:b4,thickness=:b5,vertical_wind_shear=:b6 where tropopause_id=:b\
7";
    sqlstm.iters = (unsigned int  )loop;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from tropopause  where tropopause_id=:b1";
    sqlstm.iters = (unsigned int  )loop;
